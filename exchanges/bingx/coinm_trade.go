...
func (e *Exchange) PlaceCoinMOrder(ctx context.Context, arg *PlaceCoinMOrderRequest) (*CoinMOrderAck, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodPost, "cswap/v1/trade/order", params, &resp)
}
...
func (e *Exchange) GetCoinMCommissionRate(ctx context.Context) (*CoinMCommissionRate, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/user/commissionRate", nil, &resp)
}
...
func (e *Exchange) GetCoinMLeverage(ctx context.Context, symbol currency.Pair) (*CoinMLeverage, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/leverage", params, &resp)
}
...
func (e *Exchange) SetCoinMLeverage(ctx context.Context, symbol currency.Pair, side string, leverage int64) (*CoinMLeverage, error) {
	...
	var resp *CoinMLeverage
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodPost, "cswap/v1/trade/leverage", params, &resp)
}
...
func (e *Exchange) CancelAllCoinMOrders(ctx context.Context, symbol currency.Pair) (*CoinMCancelOrdersResponse, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodDelete, "cswap/v1/trade/allOpenOrders", params, &resp)
}
...
func (e *Exchange) CloseAllCoinMPositions(ctx context.Context, symbol currency.Pair) (*CoinMCloseAllPositionsResponse, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodPost, "cswap/v1/trade/closeAllPositions", params, &resp)
}
...
func (e *Exchange) GetCoinMPositions(ctx context.Context, symbol currency.Pair) ([]*CoinMPosition, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/user/positions", params, &resp)
}
...
func (e *Exchange) GetCoinMAccountAssets(ctx context.Context, symbol currency.Pair) ([]*CoinMAccountAsset, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/user/balance", params, &resp)
}
...
func (e *Exchange) GetCoinMForceOrders(ctx context.Context, symbol currency.Pair, autoCloseType string, startTime, endTime time.Time, limit uint64) ([]*CoinMOrder, error) {
	...
	var resp []*CoinMOrder
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/forceOrders", params, &resp)
}
...
func (e *Exchange) GetCoinMOrderTradeDetail(ctx context.Context, orderID string, pageIndex, pageSize uint64) ([]*CoinMTradeDetail, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/allFillOrders", params, &resp)
}
...
func (e *Exchange) CancelCoinMOrder(ctx context.Context, symbol currency.Pair, orderID int64, clientOrderID string) (*CoinMOrder, error) {
	...
	if err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodDelete, "cswap/v1/trade/cancelOrder", params, &resp); err != nil {
		return nil, err
	}
...
func (e *Exchange) GetCoinMOpenOrders(ctx context.Context, symbol currency.Pair) ([]CoinMOrder, error) {
	...
	if err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/openOrders", params, &resp); err != nil {
		return nil, err
	}
...
func (e *Exchange) GetCoinMOrderDetail(ctx context.Context, symbol currency.Pair, orderID int64, clientOrderID string) (*CoinMOrder, error) {
	...
	var resp *CoinMOrderDetailResponse
	if err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/orderDetail", params, &resp); err != nil {
		return nil, err
	}
	return &resp.Order, nil
}
...
func (e *Exchange) GetCoinMOrderHistory(ctx context.Context, symbol currency.Pair, orderID int64, startTime, endTime time.Time, limit uint64) ([]CoinMOrder, error) {
	...
	var resp *CoinMOrdersResponse
	if err := e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/orderHistory", params, &resp); err != nil {
		return nil, err
	}
	return resp.Orders, nil
}
...
func (e *Exchange) GetCoinMMarginType(ctx context.Context, symbol currency.Pair) ([]*CoinMMarginType, error) {
	...
	return resp, e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodGet, "cswap/v1/trade/marginType", params, &resp)
}
...
func (e *Exchange) SetCoinMMarginType(ctx context.Context, symbol currency.Pair, marginType string) error {
	...
	return e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodPost, "cswap/v1/trade/marginType", params, &struct{}{})
}
...
func (e *Exchange) AdjustCoinMIsolatedMargin(ctx context.Context, symbol currency.Pair, amount float64, adjustmentType int64, positionSide string) error {
	...
	return e.SendAuthenticatedHTTPRequest(ctx, exchange.RestSpot, http.MethodPost, "cswap/v1/trade/positionMargin", params, &struct{}{})
}
